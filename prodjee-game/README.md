...
| **Practice** (not PYQ) | 866 | Anu's coaching PDFs: Sri Chaitanya *Total Physics Important Questions* (233); ALLEN Kota Class 11 assignments — Circular Motion 20–22, Centre of Mass 24, Work-Power-Energy 25, Momentum TIPS-09, Impulse-Momentum 26, Rotation 28–31/34/36, Variable Mass 32, Elasticity 33, Calorimetry 35, Thermal Expansion 37, Conduction 38, Radiation 39, KTG & Thermodynamics 40, Fluid Statics 08, Surface Tension 10; ALLEN Assignment 26 Optical Instruments; Physics Sir JEE Ray Optics I and Rotational Mechanics I–III; SAT T+R kinematics; Rotational Equilibrium sheet | Source key **and** own solution; any key that disagrees with the worked solution is skipped, not "fixed". Multi-correct, matrix-match and proof questions are skipped. Copyrighted by the institutes: confirm rights before a paid launch. Stored in `practice.js`, gold "Practice" tag |
