...
| **PYQ — JEE Main 2025–26** | 2640 (2026: 1395 of 1422; 2025: 1245 of 1275) | Official NTA papers, question text via ExamSide. 2026: 21, 22, 23, 24, 28 Jan and 2, 4, 5, 6, 8 Apr (19 shifts). 2025: 23, 24, 28, 29 Jan and 2, 3, 4, 7 Apr (both shifts) + 8 Apr Shift 2 (17 shifts; 22 Jan 2025 is covered by the older bank above) | Each item is solved independently; kept only where the official key matches. Dropped, bonus, multi-correct, ambiguous and key-disputed items are skipped (reason recorded in the verdict files). Hints and solutions are original. **Every figure is an original redraw** (RDKit for structures, hand-built SVG for physics/graphs); no source artwork or watermarks are used. Stored in `pyq.js` + `figures/pyq/*.svg`, source tag e.g. "JEE Main 2026 · 21 Jan · Shift 2" |
